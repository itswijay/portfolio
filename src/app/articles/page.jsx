...
const articles = () => {
  const blogSchema = {
    ...
    '@type': 'Blog',
    name: 'Pubudu Wijesundara - Tech Blog & DevOps Insights',
    description:
      'Articles about Technology, DevOps, Cyber Security, and web development',
    url: 'https://www.itswijay.me/articles',
    author: {
      '@type': 'Person',
    ...
    blogPost: {
      '@type': 'BlogPosting',
      headline: 'Latest articles and tutorials',
      keywords: 'Technology, DevOps, Cyber Security, Web Development',
    },
  }
